package kr.ac.kpu.game.s2016184024.lecture03;
...
public class MainActivity extends AppCompatActivity  {
    ...
    public void onBtnApply(View view) {
        ...
        String text = checked ? "Using Firewall" : "Not usingFirewall";
    ...
    public void onCheckFirewall(View view) {
        boolean checked = firewallCheckbox.isChecked();
        String text = checked ? "Using Firewall" : "Uncheck usingFirewall";
        outTextView.setText(text);
    }
